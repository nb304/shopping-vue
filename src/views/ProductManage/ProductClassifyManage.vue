          ...
          <el-row :gutter="24">
            ...
            <el-col :sm="{span: 24}" :xs="{span: 24}">
              <el-form-item label="适应季节" style="width:100%;">
                <el-cascader
                  v-model="addProductLeiMuForm.leimuAdaptSeason"
                  placeholder="请选择该类目的适应季节"
                  :options="fourOptions"
                  :props="props"
                  collapse-tags
                  clearable
...
export default {
  data() {
    return {
      // 季节数据集合
      fourOptions: [{ value: 1, label: '春季' }, { value: 2, label: '夏季' }],
      props: {
        multiple: true
      },
      // 网页的宽高
