    ...
    <el-row :gutter="24">
      ...
      <el-col id="jurisdictionInfo" :lg="{span: 4}" :xs="{span: 24}">
        <el-row :gutter="24">
          ...
          <el-col :lg="{span: 24}" :xs="{span: 24}">
            <el-tree ref="tree" :data="jurisdictionList" show-checkbox node-key="id" highlight-current :props="defaultProps" />
          </el-col>
        </el-row>
      </el-col>
      <!--=================权限信息标签模块(结束)========================-->
      ...
      <el-col id="basicInfo" :lg="{span: 5}" :xs="{span: 24}">
        <el-form :model="addUserForm" :inline="true" class="demo-form-inline" :rules="rules">
          ...
          <el-row :gutter="24">
            ...
            <el-col :lg="{span: 24}" :xs="{span: 24}">
              <el-form-item label="角色名称" prop="userPid">
                <el-input v-model="addUserForm.userPid" placeholder="请输入角色名称"><i slot="prefix" class="el-icon-edit" /></el-input>
              </el-form-item>
            </el-col>
        ...
        <el-row :gutter="24">
          ...
          <el-col :lg="{span: 24}" :xs="{span: 24}">
            <el-table v-loading="listLoading" :data="userList" stripe="true" element-loading-text="Loading" style="width: 100% !important;"
              ...
              <el-table-column label="角色名" show-overflow-tooltip="true" min-width="150px" header-align="center" align="center">
                <template slot-scope="scope">
                  <span>{{ scope.row.userId }}</span>
                </template>
              </el-table-column>
              <el-table-column label="创建时间" show-overflow-tooltip="true" width="120px">
                <template slot-scope="scope">
              ...
              <el-table-column label="人员数" show-overflow-tooltip="true" width="70px" header-align="center" align="center">
                <template slot-scope="scope">
              ...
              <el-table-column fixed="right" label="操作" width="150" header-align="center" align="center">
                <template slot-scope="scope">
                  <el-button type="text" size="20px" @click.native.prevent="removeStoreUser(scope.row, list)"> 注销</el-button>
                  <el-button type="text" size="20px" @click.native.prevent="updateStoreUser(scope.row, list)"> 修改
                  </el-button>
                  <el-button type="text" size="20px"> 删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-col>
            ...
            <el-form :model="updateUserForm" :inline="true" class="demo-form-inline" :rules="rules">
              <el-row :gutter="24">
                <el-col :lg="{span:12}" :xs="{span: 24}">
                  ...
                  <el-col :lg="{span: 24}" :xs="{span: 24}">
                    <el-form-item label="角色名称" prop="userPid">
                      <el-input v-model="updateUserForm.userPid" placeholder="请输入角色名称"><i slot="prefix" class="el-icon-edit" /></el-input>
                    </el-form-item>
                  </el-col>
                </el-col>
...
<style>
  ...
  #RoleList .el-divider span {
    /*分割线样式*/
    color: #606266;
    font-weight: bold;
  }

  #RoleList .el-form--inline .el-form-item {
    margin: 0px !important;
    margin-bottom: 19px !important;
  }

  #RoleList .el-table th .cell {
    word-break: keep-all;
    white-space: nowrap;
    padding: 0px 0px;
  }

  #RoleList .el-table th {
    padding: 2px 0px;
    padding-left: 10px;
    color: #606266;
  }
  ...
  @media only screen and (min-width: 1501px) and (max-width: 2000px) {
    ...
    #RoleList #basicInfo .el-form-item__content {
      width: 67% !important;
    }

    #RoleList #basicInfo button {
      width: 82% !important;
      margin-left: 28px;
    }
  }
