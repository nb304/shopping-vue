  ...
  <div id="stortTypeDiv" style="margin:30px ;">
      ...
      <el-row :gutter="24">
        <el-col :sm="{span: 8}" :xs="{span: 23}" style="margin-bottom: 10px;; ">
          <el-form-item label="店铺类型" style="width:100%;">
            <el-input v-model="storeTypeSearchForm.typeName" placeholder="查询分类名称" style="width:100%;"><i slot="prefix"
                class="el-icon-edit" /></el-input>
          </el-form-item>
        </el-col>
    ...
    <el-row :gutter="24">
      <el-col :sm="{span: 5, offset: 18}" :xs="{span: 24}">
        <el-pagination background layout="prev, pager, next" current-page="30" :total="total" page-size="3" small="false"
          style="margin-top: 15px;margin-right: 10px;" @current-change="handleSizeChange" />
      </el-col>
    </el-row>
    <!-- ======================= 分页层 (结束) =========================  -->
    ...
    <!-- ======================= 添加店铺分类 =========================  -->
    <el-dialog custom-class="addStoreType" width="400px" top="1vh" :append-to-body="true" :close-on-click-modal="false" title="添加店铺分类"
        ...
        <el-row :gutter="24">
          <el-col :sm="{span: 24}" :xs="{span: 24}">
            <el-form-item label="分类名称" style="width:100%;">
              <el-input v-model="addStoreTypeForm.stroeName" placeholder="请输入分类名称" style="width:100%;"><i slot="prefix"
                  class="el-icon-edit" /></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="{span: 24}" :xs="{span: 24}">
          ...
          <el-col :sm="{span: 24}" :xs="{span: 24}">
            <el-form-item label="总售出量" style="width:100%;">
              <el-input v-model="addStoreTypeForm.stroeName" placeholder="请输入总售出量" style="width:100%;"><i slot="prefix"
                  class="el-icon-edit" /></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="{span: 24}" :xs="{span: 24}">
            <el-form-item label="月售出量" style="width:100%;">
              <el-input v-model="addStoreTypeForm.stroeName" placeholder="请输入月售出量" style="width:100%;"><i slot="prefix"
                  class="el-icon-edit" /></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="{span: 24}" :xs="{span: 24}">
            <el-form-item label="好评率" style="width:100%;">
              <el-input v-model="addStoreTypeForm.stroeName" placeholder="请输入好评率" style="width:100%;"><i slot="prefix"
                  class="el-icon-edit" /></el-input>
            </el-form-item>
          </el-col>
    ...
    <!-- ======================= 查看分类达到要求 =========================  -->
    <el-dialog custom-class="addStoreType" width="400px" :append-to-body="true" :close-on-click-modal="false" title="查看分类达到要求"
    ...
    <!-- ======================= 查看分类达到要求(结束) =========================  -->
     ...
     <!-- ======================= 修改店铺分类 =========================  -->
    <el-dialog custom-class="addStoreType" width="400px" top="1vh" :append-to-body="true" :close-on-click-modal="false" title="修改店铺分类"
