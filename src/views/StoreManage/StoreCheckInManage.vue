	...
	<div id="checkInDiv" style="margin:30px ;">
		...
		<el-form :inline="true" :model="stroreCheckInSearchForm" class="demo-form-inline">
			<el-row :gutter="24">
				<el-col :sm="{span:9}" :xs="{span: 23}" style="margin-bottom: 10px;; ">
					<el-date-picker v-model="stroreCheckInSearchForm.queryTimes" style="width:100%;" type="daterange" align="right"
				...
				<el-col :sm="{span: 5}" :xs="{span: 23}" style="margin-bottom: 10px;;">
					<el-select style="width: 100%;;" v-model="stroreCheckInSearchForm.querykey" placeholder="选择查询条件">
		...
		<el-row :gutter="24">
			<el-col :sm="{span: 5, offset: 18}" :xs="{span: 24}">
				<el-pagination background layout="prev, pager, next" current-page="30" total="100" page-size="3" small="false"
