<template>
	...
	<div id="stortInfo" style="margin: 50px 0px 0 0px !important;">
		...
		<!-- ======================= 设置店长支付宝 =========================  -->
		<el-dialog :append-to-body="true" width="400px" :close-on-click-modal="false" title="编辑店长支付宝账户" :visible.sync="stortDivFlags.gatheringFlag"
		 class="title-menu-min2">
			...
			<el-dialog custom-class="verificationClass" :append-to-body="true" width="400px" :close-on-click-modal="false" title="编辑店长支付宝账户"
			 :visible.sync="stortDivFlags.verificationFlag" class="title-menu-min2">
		...
		<el-dialog :append-to-body="true" width="60%" custom-class="storeLogo" :close-on-click-modal="false" title="设置店铺LOGO"
		 :visible.sync="stortDivFlags.storeLogoFlag" class="title-menu-min2">
			...
			<el-row :gutter="24">
				<el-col :sm="{span: 23}" :xs="{span: 23}">
					<el-upload ref="upload" class="upload-demo" action="http://192.168.0.127/ucc/vue/upload" :on-preview="handlePreview"
					 :on-remove="handleRemove" name="fileImage" :multiple="true" limit="1" accept="image/*" :file-list="fileList"
