...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '商品品牌管理', icon: 'tree' }
      },
      {
        path: 'tree',
        name: 'Tree',
        component: () => import('@/views/tree/index'),
        meta: { title: '商品类目管理', icon: 'tree' }
      },
      {
        path: 'tree',
        name: 'Tree',
        component: () => import('@/views/tree/index'),
        meta: { title: '商品运费管理', icon: 'tree' }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '商品申请采购', icon: 'form' }
      },
			{
			  path: 'index',
			  name: 'Form',
			  component: () => import('@/views/form/index'),
			  meta: { title: '添加采购管理', icon: 'form' }
			},{
        path: 'index',
        name: 'Form',
        component: () => import('@/views/form/index'),
        meta: { title: '采购列表管理', icon: 'form' }
      }
    ]
  },
